...
import '../../PagesStyles/ClientPageStyles/homeHomeFooterComponent.css';

class HomeFooterComponent extends Component {
    state = {}
    render() {
        return (
            <div className='homefootercomponent'>
                <div className='homefootertop'>

                    <div className='homefootertopleft'>

                        <div className='homefooterlogotext'>
                            <img src={require('../../gas-cylinder11.png')} alt='Gas Space Logo' />
                            <p>Gas <span>Space</span></p>
                        </div>

                        <div className='homefooterdownloadbuttons'>
                            <a href="">
                ...
                <div className='homefooterbottom'>
                    <div className='homefooterbottombegin'>
                    ...
                    <div className='homefooterbottomend'>
