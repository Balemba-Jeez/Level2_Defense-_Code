...
import '../../PagesStyles/deliveryPageStyles/deliverySubmitFormpage.css';
import DeliverySubAppHeaderRightItem from '../Delivery/deliverySubAppHeaderRightItem';

class DeliverySubmitFormPage extends Component {
    state = {}
    render() {
        return (
            <div className='deliverysubmitformpage'>

                <div className='deliverysubmitformppageheader'>

                    <div className='deliverysubmitformppageheaderleft' >
                        <button>
                ...
                <div className='deliverysubmitformppagebody'>

                    <div className='deliverysubmitformpagetext'>
                    ...
                    <div className='deliverysubmitformpagelist'>
                        <ol>
                    ...
                    <div className='deliverysubmitformpageinput'>
                        <div className='deliverysubmitformpageinputimage'>

                            <img src={require('../../profile_photo_global.png')} alt="Image Demonstration" />

                        </div>

                        <div className='deliverysubmitformpageinputbutton'>
                ...
                <div className='deliverysubmitformppagefooter'>
...
export default DeliverySubmitFormPage;