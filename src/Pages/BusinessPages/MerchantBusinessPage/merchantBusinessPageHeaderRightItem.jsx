...
import '../../../PagesStyles/BusinessPageStyles/merchantbusinesspageHeaderRightItem.css'
class MerchantBusinessPageHeaderRightItem extends Component {
    state = {}
    render() {
        return (
            <div className='merchantbusinesspageheader_rightitem'>
                <div>
...
export default MerchantBusinessPageHeaderRightItem;