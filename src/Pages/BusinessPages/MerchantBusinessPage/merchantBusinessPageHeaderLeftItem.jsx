...
import '../../../PagesStyles/BusinessPageStyles/merchantBusinessPageHeaderLeftItem.css'

class MerchantBusinessPageHeaderLeftItem extends Component {
    state = {}
    render() {
        return (
            <div className='merchantbusinesspageheader_leftitem'>
...
export default MerchantBusinessPageHeaderLeftItem;